 ...
 */
package io.sapphiremc.sapphire.test.nbt;

import io.sapphiremc.sapphire.test.SapphireTestPlugin;
import io.sapphiremc.sapphire.test.nbt.blocks.BlockTest;
import io.sapphiremc.sapphire.test.nbt.chunks.ChunkNBTPersistentTest;
import io.sapphiremc.sapphire.test.nbt.compounds.EqualsTest;
import io.sapphiremc.sapphire.test.nbt.compounds.ForEachTest;
import io.sapphiremc.sapphire.test.nbt.compounds.GetterSetterTest;
import io.sapphiremc.sapphire.test.nbt.compounds.GsonTest;
import io.sapphiremc.sapphire.test.nbt.compounds.IteratorTest;
import io.sapphiremc.sapphire.test.nbt.compounds.ListTest;
import io.sapphiremc.sapphire.test.nbt.compounds.MergeTest;
import io.sapphiremc.sapphire.test.nbt.compounds.RemovingKeysTest;
import io.sapphiremc.sapphire.test.nbt.compounds.StreamTest;
import io.sapphiremc.sapphire.test.nbt.compounds.SubCompoundsTest;
import io.sapphiremc.sapphire.test.nbt.compounds.TypeTest;
import io.sapphiremc.sapphire.test.nbt.entity.EntityCustomNBTPersistentTest;
import io.sapphiremc.sapphire.test.nbt.entity.EntityTest;
import io.sapphiremc.sapphire.test.nbt.file.FileTest;
import io.sapphiremc.sapphire.test.nbt.gameprofile.GameProfileTest;
import io.sapphiremc.sapphire.test.nbt.item.DirectApplyTest;
import io.sapphiremc.sapphire.test.nbt.item.EmptyItemTest;
import io.sapphiremc.sapphire.test.nbt.item.ItemConvertionTest;
import io.sapphiremc.sapphire.test.nbt.item.ItemMergingTest;
import io.sapphiremc.sapphire.test.nbt.tiles.TileTest;
import io.sapphiremc.sapphire.test.nbt.tiles.TilesCustomNBTPersistentTest;
